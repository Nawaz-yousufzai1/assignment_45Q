...
*/
var current_users = ["maaz", "kashif", "furqan", "hamza", "danish"];
var new_users = ["javaid", "imran", "danish", "furqan", "arshad"];
var _loop_1 = function (new_username) {
    ...
    if (usernameExists) {
        console.log(" The username '".concat(new_username, "' is Exists. you need to enter new username."));
    }
    else {
