...
function city_country(city:string, country:string){
  ...
  const cityCountry:string=city_country("Lahore", "Pakistan"); 
  console.log(cityCountry);           // print Lahore, Pakistan
  const cityCountry1:string=city_country("Riaz","Saudi Arabia");
  console.log(cityCountry1);   // print Riaz, Saudi Arabia
  const cityCountry2:string=city_country("Kairo","Egypt");
