...
*/
console.log("Addition:5+3=\t\t".concat(5 + 3));
console.log("Subtraction:16-8=\t".concat(16 - 8));
console.log("multiplication:8*1=\t".concat(8 * 1));
console.log("Division:16/2=\t\t".concat(16 / 2));
